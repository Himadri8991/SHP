...
export default function CategoryPage() {
  const listings = PROPERTY_LISTINGS.filter(p => p.category === "land-plot");
        ...
        <div className="border-b border-[var(--color-stone-200)] pb-12 sm:pb-16 bg-white">
          <div className="container-wide">
            <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-eyebrow text-[var(--color-gold-500)]">Land & Plots · High-Yield Capital Corridors</p>
            </div>
            <h1 className="text-section-title text-[var(--color-stone-900)] leading-tight">
              Freehold Land & Sanctioned Plots
            </h1>
            <p className="text-subhead text-[var(--color-stone-600)] font-light mt-3 max-w-2xl">
              Pre-vetted residential and commercial plots in Newtown Action Area I/II/III and Rajarhat with clear ownership titles and municipal boundaries.
            </p>
          </div>
        </div>
