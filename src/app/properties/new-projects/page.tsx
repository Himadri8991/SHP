...
export default function CategoryPage() {
  const listings = PROPERTY_LISTINGS.filter(p => p.category === "new-project");
        ...
        <div className="border-b border-[var(--color-stone-200)] pb-12 sm:pb-16 bg-white">
          <div className="container-wide">
            <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-eyebrow text-[var(--color-gold-500)]">New Projects · Premier Kolkata Corridors</p>
            </div>
            <h1 className="text-section-title text-[var(--color-stone-900)] leading-tight">
              Upcoming & Ready New Developments
            </h1>
            <p className="text-subhead text-[var(--color-stone-600)] font-light mt-3 max-w-2xl">
              Discover newly launched architectural towers, gated enclave communities, and luxury residential projects with verified sanction plans.
            </p>
          </div>
        </div>
