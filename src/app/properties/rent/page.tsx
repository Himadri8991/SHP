...
export default function CategoryPage() {
  const listings = PROPERTY_LISTINGS.filter(p => p.category === "rent");
        ...
        <div className="border-b border-[var(--color-stone-200)] pb-12 sm:pb-16 bg-white">
          <div className="container-wide">
            <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-eyebrow text-[var(--color-gold-500)]">Residential & Commercial Rent · Premium Portfolios</p>
            </div>
            <h1 className="text-section-title text-[var(--color-stone-900)] leading-tight">
              Luxury Long-Term Leases
            </h1>
            <p className="text-subhead text-[var(--color-stone-600)] font-light mt-3 max-w-2xl">
              High-specification executive residences, furnished corporate penthouses, and prime commercial leasing spaces across Newtown and Kolkata.
            </p>
          </div>
        </div>
