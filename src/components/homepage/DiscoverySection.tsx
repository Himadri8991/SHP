...
export default function DiscoverySection() {
  ...
  const developers = [
    ...
    { id: "TATA Realty", label: "TATA Realty" },
    { id: "Merlin Group", label: "Merlin Group" },
    { id: "Ambuja Neotia", label: "Ambuja Neotia" },
    { id: "Mani Group", label: "Mani Group" },
    { id: "Emami Realty", label: "Emami Realty" },
    { id: "Siddha Group", label: "Siddha Group" },
    { id: "Shrachi Realty", label: "Shrachi Realty" },
    { id: "Purti Realty", label: "Purti Realty" },
    { id: "Vinayak Group", label: "Vinayak Group" },
    { id: "Ruchi Realty", label: "Ruchi Realty" },
